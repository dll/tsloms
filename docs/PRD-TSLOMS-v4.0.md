...
**版本说明**：V4.0 是**结项候选版**。在 V3.1 基础上完成全部运维业务闭环（含成本闭环：采购→入库→领料→自动费用归集），并补齐固件 OTA 管理。以 PRD V2.0 与《设备协议确认清单》为业务范围底盘，协议 PDF 与故障 DOCX 为权威依据。**本版作为最终实现基线。**
...
| 文档 | 路径 |
|------|------|
| 本需求文档 V4.0 | `docs/PRD-TSLOMS-v4.0.md` |
| 结项审核报告 V4.0 | `docs/SAR-TSLOMS-v4.0.md` |
